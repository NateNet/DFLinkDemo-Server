// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TaskControllerTest.cs" company="Demandforce">
//   TODO:
// </copyright>
// <summary>
...
namespace API.Tests
{
    ...
    public class TaskControllerTest
    {
        ...
        public void GetTest()
        {
            ...
            BusinessCredentials credentials = new BusinessCredentials { LicenseKey = "xxxxx-xxxxxx" };
        ...
        {
            TaskController target = new TaskController(); // TODO: Initialize to an appropriate value
            StatusUpdateBody requestBody = new StatusUpdateBody
                                               {
                                                   BusinessCredentials =
